...
interface RespirAirLogoProps {
  className?: string;
}

const RespirAirLogo = forwardRef<SVGSVGElement, RespirAirLogoProps>(
  ({ className }, ref) => {
    return (
      <motion.svg
        ref={ref}
...
RespirAirLogo.displayName = 'RespirAirLogo';

export default RespirAirLogo;
